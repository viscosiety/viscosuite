...
<xsl:stylesheet version="3.0"
    ...
    <!--
      SIU_S12.xslt
      ============
      Maps an HL7v2 SIU^S12 (New Appointment Booking) message
      to a FHIR R4 transaction Bundle containing:
        - Patient     (from PID), conditional PUT on MR identifier
        - Appointment (from SCH), conditional PUT on filler/placer appointment ID

      All SIU variants (S12/S13/S14/S15) share the SIU_S12 message structure in HAPI HL7v2.
      S12, S13, S14 set status=booked; S15 sets status=cancelled.
            ...
            <entry>
                ...
                <resource>
                    <xsl:apply-templates select="hl7:SCH" mode="Appointment">
                        ...
                        <xsl:with-param name="status"           select="'booked'"/>
