...
<!--
    ...
    Returns a demo Patient (Jan de Vries, PAT-001) with realistic R5 fields.
    R5 adds name.text, address.text, and drops contact.name.use in favour of name.text.
-->
    ...
    <xsl:template match="/id">
        ...
        <Patient xmlns="http://hl7.org/fhir">
            ...
            <address>
                <use value="home"/>
                <type value="both"/>
                <text value="Keizersgracht 123, 1015CJ Amsterdam, NLD"/>
