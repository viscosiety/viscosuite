#!/usr/bin/env bash
# send-siu-s13.sh
# SIU^S13 Appointment Reschedule — moves APT-2026-001 from Jun 10 09:00 to Jun 12 14:00.
# Run after send-siu-s12.sh.
#
# Env vars:
...
MSG=$(printf '%s\r' \
  "MSH|^~\\&|SchedSystem|HospitalA|viscolink|viscosiety|${TS}||SIU^S13^SIU_S12|${MSG_ID}|P|2.5" \
